...
export class DashboardDailySupervisorComponent {
  ...
  dailyReportOptions:any = { data: [], columns: [], destroy: true }
  ...
  setTableData(data: any) {
    ...
    this.dailyReportOptions.data = data,
    this.dailyReportOptions.columns =[
        {
          data: null, 
          title: 'Action',
          width: '120px',
          ...
          render: (data: any, type: any, row: any) => {
            return `
              <a href="#/daily-report/project/${row?.projectId}?date=${this.formatDate2(row?.todaysDate?.toDate())}">
        ...
        },
        {
          ...
          searchable: false,
          render: (data: any, type: any, row: any) => {
            return this.countNumber(row?.tradeFormArray) || '0';
          },
        },
        {
          data: 'staffFormArray',
          ...
          render: (data: any, type: any, row: any) => {
            ...
            return (this.countNumber(row?.staffFormArray) + staffCount) || '0';
          },
        },
        {
          ...
          searchable: false,
          render: (data: any, type: any, row: any) => {
            return this.countNumber(row?.visitorFormArray) || '0';
          },
        },
      ]  
