...
export class VisitorsComponent implements OnInit {
  ...
  public settings = {
    ...
    columns: {
      customactions: {
        ...
        renderComponent: VisitorsRenderComponent
    ...
    this.data_api.getFBVisitors().subscribe(data => {
        if(data){
          if(data.visitorArray){
            ...
            // this.source = new LocalDataSource(data.visitorArray)
            this.source = data.visitorArray
            this.listVisitors = data.visitorArray
          }
        }
        this.setTableData()
  ...
  setTableData(){
    ...
    this.dtOptions.columns  = [
      ...
      { title: 'Visitor Name', data: 'visitorName',
       }
    ]
    this.dtTrigger.next();
}
...
openDeleteDialog(rowData:any): void {
  ...
  downloadCSV(){
        ...
        if(this.listVisitors){
            ...
            this.listVisitors.forEach(data =>{
...
export class VisitorsAddDialog implements OnInit {
  ...
  public createFBVisitor(): void {
      ...
      console.log(this.addFestForm.value.visitorName);
      
      this.data_api.createFBVisitor(this.addFestForm.value.visitorName).then((result) => {
          console.log('Created new Visitor Global List successfully!');
          this.addLog(result);
