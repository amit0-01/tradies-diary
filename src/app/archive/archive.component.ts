...
export class ArchiveComponent {
  ...
  public getProjects(){
      ...
      this.data_api.getArchivedProjects().subscribe((data) => {
          console.log(data);
          data.forEach(data =>{ 
  ...
  public getArchiveReports(){
        this.spinnerService.show();

        this.data_api.getArchiveReports().subscribe((data) => {
  ...
  public filterReports(){
    this.spinnerService.show();
      ...
      this.data_api.getArchivedWeeklyReportsQuery(this.filterWeeklyReports.value).subscribe((data) => {
        console.log(data);
        this.source.load(data);
        this.reportList = data;
        this.spinnerService.hide();
