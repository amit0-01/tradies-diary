...
@Component({
  template: `
    <a href="#/weekly-report/edit/{{renderValue.id}}"><i class="material-icons">edit</i></a>
...
export class WeeklyRenderSupervisorComponent implements ViewCell, OnInit {
...
@Component({
  selector: 'weekly-deletedialog',
  templateUrl: 'weekly-deletedialog.html',
  providers: [
    {provide: DateAdapter, useClass: AppDateAdapter},
    {provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS}
  ]
...
export class WeeklyDeleteDialog implements OnInit {

  deleteFestForm: FormGroup;

  constructor(
    private formBuilder: FormBuilder,
    public dialogRef: MatDialogRef<WeeklyDeleteDialog>,
    @Inject(MAT_DIALOG_DATA) public data) {}
