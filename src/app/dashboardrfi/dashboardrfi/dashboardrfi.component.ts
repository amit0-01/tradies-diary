...
public getDocumentDefinition() {
    ...
    return {
      ...
      content: [
        ...
        this.getSummary(this.addFestForm.value.rfiName),
        { text: '', style: 'fieldHeader', margin: [0, 0, 0, 20 ],},
      ...
      const pdfDocGenerator = pdfMake.createPdf(documentDefinition);
        ...
        pdfDocGenerator.getBuffer(async (buffer) => {
          ...
          copiedPagesA.forEach((page) => mergedPdf.addPage(page));
            ...
            let id = this.addFestForm.value.rfiNumber+'.pdf';
...
saveStep1Old(){
  ...
  sendAdminEmail(RfiID,projectID){
    console.log('5 is working')
      ...
      let varEmails = this.rfiSettingsData.rfiEmailRecipient;
      if(varEmails){
      ...
      const callableTest = this.functions.httpsCallable('sendFBRFIsSubmit');
