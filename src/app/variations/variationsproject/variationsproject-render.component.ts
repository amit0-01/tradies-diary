...
@Component({
  ...
  `<a href="#/variations/project/{{value}}/edit/{{renderValue.id}}"><i class="material-icons">edit</i></a>
  <a target="_blank" href="{{renderValue.pdfLink}}"><i class="material-icons">download</i></a>
  <a [routerLink]="[]" (click)="openDeleteDialog()"><i class="material-icons">delete</i></a>`

})
export class   VariationsProjectRenderComponent implements ViewCell, OnInit {
...
@Component({
  selector: 'variationsproject-deletedialog',
  templateUrl: 'variationsproject-deletedialog.html',
  providers: [
    {provide: DateAdapter, useClass: AppDateAdapter},
    {provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS}
  ]
...
export class VariationsProjectDeleteDialog implements OnInit {
  ...
  constructor(
    private formBuilder: FormBuilder,
    private data_api: DatasourceService,
    public dialogRef: MatDialogRef<VariationsProjectDeleteDialog>,
    @Inject(MAT_DIALOG_DATA) public data) {}
