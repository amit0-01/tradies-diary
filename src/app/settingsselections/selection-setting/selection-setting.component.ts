...
@Component({
  selector: 'app-selection-setting',
  templateUrl: './selection-setting.component.html',
  providers : [
...
export class SelectionSettingComponent {
  editForm: FormGroup;
  public emailData;
  ...
  public ngOnInit() {
      ...
      this.editForm = this.formBuilder.group({
          selEmailRecipient : ['', Validators.required],
          selDefaultOpening : '',
          selDefaultClosing : '',
          selSetJobNum: '',
          selSetCode : '',
      ...
      console.log(data);
        ...
        if(data){
          ...
          this.projectList.sort((a, b) => {
            return b.counterSelection - a.counterSelection;
          });

          this.hiProjSelNo = this.projectList[0].counterSelection ? this.projectList[0].counterSelection: 0;
      ...
      this.data_api.getFBSelectionSettings().subscribe((data) => {
          ...
          if(data){
              ...
              this.editForm.patchValue({
                  selEmailRecipient : data.selEmailRecipient,
                  selDefaultOpening : data.selDefaultOpening,
                  selDefaultClosing : data.selDefaultClosing,
            ...
            // this.prevSelNumber = data.varSetStartNumber ? data.varSetStartNumber : 0;
  ...
  public savestep1(){
      ...
      // if( (this.prevSelNumber != this.editForm.value.varSetStartNumber) && (this.hiProjSelNo > this.editForm.value.varSetStartNumber)){
      //     swal.fire({
      ...
      this.spinnerService.show();
      this.data_api.updateFBSelectionsSettings(this.editForm.value).then(() => {
          console.log('Updated successfully!');
          this.spinnerService.hide();

         swal.fire({
              title: "Selections Settings Updated",
              // text: "You clicked the button!",
              buttonsStyling: false,
              customClass: {
                  confirmButton: 'btn btn-success',
